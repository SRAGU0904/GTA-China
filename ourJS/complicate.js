...
// 示例数据
var groupsAttackRegions={'Afghanistan': ['Taliban', 12880],
    'Iraq': ['ISIS', 7202],
    'Philippines': ["New People's Army (NPA)", 3439],
    'Yemen': ['Houthi extremists (Ansar Allah)', 3078],
    'Turkey': ["Kurdistan Workers' Party (PKK)", 2259],
    'India': ['Communist Party of India - Maoist (CPI-Maoist)', 2112],
    'Sri Lanka': ['Liberation Tigers of Tamil Eelam (LTTE)', 1592],
    'Pakistan': ['Tehrik-i-Taliban Pakistan (TTP)', 1489],
    'Syria': ['ISIS', 854],
    'Palestine': ['Palestinians', 562],
    'Saudi Arabia': ['Houthi extremists (Ansar Allah)', 438],
    'Israel': ['Palestinians', 396],
    'Thailand': ['Separatists', 380],
    'Lebanon': ['Hezbollah', 312],
    'Nepal': ['Communist Party of Nepal - Maoist (CPN-Maoist-Chand)', 302],
    'Cambodia': ['Khmer Rouge', 158],
    'Indonesia': ['Free Aceh Movement (GAM)', 116],
    'Myanmar': ['Arakan Army (AA)', 108],
    'Bangladesh': ['Bangladesh Nationalist Party (BNP)', 101],
    'Iran': ['Mujahedin-e Khalq (MEK)', 98],
    'China': ['Uighur Separatists', 86],
    'Japan': ['Chukakuha (Middle Core Faction)', 61],
    'Bahrain': ['Al-Ashtar Brigades', 12],
    'Georgia': ['South Ossetian Separatists', 10],
    'Tajikistan': ['ISIS', 4]}
var request = new XMLHttpRequest();
var dataTop20,lastID,lastGroup
setTimeout(()=>{
    request.open("get","./data/terrorismNum-top25countries.json");
    request.send(null);
...
var drawChart=function(data,maxNums,curGroup,group2Id){
    ...
    d3.select('#group-attack-region').text("袭击该地区的主要恐怖组织："+groupsAttackRegions[curGroup][0])
